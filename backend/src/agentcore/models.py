...
class RepositoryContext(BaseModel):
    ...
    environment_vars: List[str] = Field(default_factory=list, description="Required environment variables")
...
class RawRepositoryData(BaseModel):
    ...
    package_files: Dict[str, str] = Field(default_factory=dict, description="Package manager files content")
    config_files: Dict[str, str] = Field(default_factory=dict, description="Configuration files content")
